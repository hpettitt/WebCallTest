...
## Part 15: Cost Analysis Per Interview

### Cost Breakdown (Per 15-Minute Interview)

| Service | Rate | Calculation | Cost |
|---------|------|-------------|------|
| **VAPI** | $0.11/min | 15 min × $0.11 | **$1.65** |
| **OpenAI API** | Variable | Whisper + TTS + processing | **~$0.50** |
| **Railway** | $12/mo avg | $12 ÷ 100 interviews | **~$0.12** |
| **Resend** | Free-$0.05 | 1 confirmation email | **$0-0.05** |
| | | **Total per Interview** | **~$2.27-2.32** |

### OpenAI Cost Breakdown (per interview)
- Whisper (speech-to-text): $0.02/minute × 15 min = $0.30
- Text-to-speech (TTS): ~$0.045 (for ~3000 characters output)
- GPT-4 Turbo processing: ~$0.10-0.15
- **OpenAI Subtotal: ~$0.50**

### Monthly Projection (100 Interviews)

| Service | Per Interview | Monthly (100×) | Notes |
|---------|---------------|----------------|-------|
| VAPI | $1.65 | $165 | Largest cost (~72%) |
| OpenAI API | $0.50 | $50 | Medium cost (~22%) |
| Railway | $0.12 | $12-20 | Infrastructure |
| Resend | $0-0.05 | $0-5 | Email delivery |
| Airtable | $0 | $0 | Free tier |
| Domain | - | $10 | Annual/monthly |
| **Total** | **~$2.27-2.32** | **~$237-260** | Annual: ~$2,850-3,120 |

### Cost Optimization Tips

1. **Volume Discounts (VAPI)**
   - 500+ minutes/month: Negotiate custom rates
   - May reduce cost to $0.08-0.09/minute

2. **Model Selection (OpenAI)**
   - Use gpt-3.5-turbo instead of gpt-4-turbo if acceptable
   - Reduces OpenAI cost by ~30% (~$0.35 per interview)

3. **Batch Processing**
   - Process transcripts in batches for 15% discount
   - Saves ~$0.07 per interview

4. **Free Tier Optimization**
   - Use Resend free tier (100 emails/day) until $20/mo upgrade needed
   - Use Airtable free tier for 1200 records

5. **Infrastructure Scaling**
   - Keep Railway under $20/month: handle 200+ interviews
   - Cost per interview decreases with volume

### ROI Analysis (Hourly Staff Alternative)

| Method | Cost per Interview | Annual (200 interviews) | Notes |
|--------|-------------------|--------------------------|-------|
| **AI System** | $2.27 | $454 | Fully automated |
| **Junior Staff** | $15-25 | $3,000-5,000 | Manual scheduling |
| **Outsource** | $10-20 | $2,000-4,000 | 3rd party service |
| **Savings** | - | **$1,500-4,500** | Annual benefit |
...
| VAPI | $165 (100 interviews) | ~$1.65 per interview |
| OpenAI | $50 (100 interviews) | ~$0.50 per interview |
| Railway (Backend) | $12-20 | Auto-scales |
| Railway (n8n) | $5-20 | Auto-scales |
| Resend | $0-5 | Free tier first, $20/mo unlimited |
| Domain | $10 | Already owned |
| **Total (100 interviews)** | **~$237-260** | ~$2.27-2.32 per interview |
